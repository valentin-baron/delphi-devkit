...
//   ): Promise<void> {
//     if (source[0]?.project.link.owner instanceof Entities.GroupProject) {
...
//       return;
//     }
//     let treeItems = (await Runtime.projects.workspacesTreeView.items).filter((item): item is DelphiProject => item instanceof DelphiProject);
...
//     await Runtime.projects.workspacesTreeView.save(newOrder);
